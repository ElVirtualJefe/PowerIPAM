...
from apps.scan_agent.src.helpers.constants import EXTRA_LOGGING_FORMAT,DEFAULT_LOG_DATE_FORMAT,DEFAULT_DEBUG_LOG_LOCATION,DEFAULT_LOG_DIR,DEFAULT_LOG_FORMAT,APPLICATION_NAME
...
from apps.scan_agent.src.helpers.config import LOG_LEVEL,LOG_FILE_LEVEL,LOG_LOCATION
