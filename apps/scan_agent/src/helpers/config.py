...
print(f'{__name__=}')
if __name__ == 'src.helpers.config':
    from src.helpers.constants import APPLICATION_NAME,DEFAULT_DEBUG_LOG_FILE
    from src.helpers.common import whoami
else:
    from apps.scan_agent.src.helpers.constants import APPLICATION_NAME,DEFAULT_DEBUG_LOG_FILE
    from apps.scan_agent.src.helpers.common import whoami
