...
class IpAddress(_message.Message):
    __slots__ = ("id", "ip_address", "owner", "description", "is_gateway", "hostname", "state_id", "is_available", "last_seen", "last_modified", "date_created", "subnet_id", "mac_address")
